          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-700 mb-4 italic">
                Сын узнал об Умскул в 9 классе. После ОГЭ решили выбрать для ЕГЭ
                тариф "Премиум" с летней подготовкой. Отличные преподаватели
                (Настя, Надя, Аля, Александр) объясняют понятно и с юмором.
                Удобный формат онлайн/запись, поддержка кураторов. Умскул -
                супер! С выбором не ошиблись.
              </p>
